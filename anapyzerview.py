...
class AnaPyzerView(tkinter.ttk.Frame):
    ...
    def _create_widgets(self):
        ...
        self._in_file_path_field_label.grid(row = 2, column = 0, # Place the Label in the UI grid,
                                            padx = AnaPyzerView.WIDGET_X_PAD, pady = AnaPyzerView.WIDGET_Y_PAD, # Give it the global widget padding
                                            sticky = 'W') # Stick to the left of its cell
        ...
        self._out_file_path_field_label.grid(row = 6, column = 0, # Place the Label in the UI grid,
                                             padx = AnaPyzerView.WIDGET_X_PAD, pady = AnaPyzerView.WIDGET_Y_PAD, # Give it the global widget padding
                                             sticky = 'W') # Stick to the left of its cell
        ...
        self._open_file_button.grid(row = 8, column = 0, # Place the button in the UI grid
                                    columnspan = 3, # Span across multiple columns in the UI grid
                                    padx = AnaPyzerView.WIDGET_X_PAD, pady = AnaPyzerView.WIDGET_Y_PAD) # Give it the global widget padding
